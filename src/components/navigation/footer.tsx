...
const Footer = () => (
        <footer className="mt-20 pb-20 flex justify-between items-center bg-slate-200 p-12 max-w-[1440px] mx-auto w-full"> 
            <div className="self-start">
                ...
                <h1>Better Honest</h1>
                <p className="text-xs">© {new Date().getFullYear()} Better Honest. All rights reserved.</p>
                </div>
            </div>
            ...
            <div className="flex gap-10">
                <div className="space-y-2">
                    ...
                    <ul className="text-sm space-y-1">
                        ...
                        <li><Link to={"/services"}>Roofing</Link></li>
                    </ul>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <ul className="text-sm space-y-1">
                        <li><Link to={"/services"}>Home Inspection</Link></li>
                        <li><Link to={"/services"}>Paint</Link></li>
                    </ul>
                </div>
            </div>
