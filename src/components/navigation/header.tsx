...
const Header = () => (
  <header className="fixed top-8 left-1/2 -translate-x-1/2 w-full px-4 py-2 max-w-[900px] border border-[rgba(230,214,173)] flex justify-between items-center mx-auto text-[rgba(125,93,108)] [--tw-bg-opacity:_0.7] bg-white rounded-xl backdrop-blur-xl shadow-md">
